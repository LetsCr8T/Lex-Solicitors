  ...
  items: [
    {
      ...
      description:
        "Legal, regulatory, governance and tax expertise under one roof, so you get joined-up advice instead of fragmented opinions.",
    },
    {
      id: "commercial",
      icon: "briefcase",
